...
export default function Home() {
  return (
    <main className="min-h-screen">
      <div className="mx-auto max-w-2xl px-4 py-30">
        <header className="mb-12">
          <h1 className="text-center text-6xl leading-tight text-white/80 lg:text-7xl">
            Let&apos;s{" "}
            <span className="text-primary font-bold">work together</span>
          </h1>
          <p className="text-muted-foreground mx-auto mt-4 max-w-lg text-center text-lg leading-relaxed md:text-xl">
