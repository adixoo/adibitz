...
export default function AnimatedButton({
    ...
    return (
        <button
            className={cn(
                "group relative flex items-center gap-2 overflow-hidden rounded-full px-6 py-3 font-medium transition-colors duration-300 group-hover:text-white cursor-pointer",
                className
            )}
        >
