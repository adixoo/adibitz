            ...
            <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-5">
                ...
                <div className="md:col-span-3">
                    <h2 className="text-5xl leading-snug font-bold text-white/80">
                        ...
                        <span className="text-purple-600">digital solutions</span>{" "}
                        for brands across <span className="text-purple-600">India & beyond.</span>
                    </h2>

                    <p className="mt-5 leading-relaxed text-white/60 text-lg">
            ...
            <div className="mt-20 rounded-xl px-6 py-16 text-white">
                <div className="mx-auto grid max-w-6xl gap-12 md:grid-cols-3">
                    {stats.map((item, index) => (
                        <div
                            key={index}
                            className="flex flex-col border-t border-b border-primary py-10"
                        >
